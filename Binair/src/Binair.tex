...
\mainmatter
\chapter{Binaire getallen}
\input{src/binair}
\section{Binair naar decimaal}
\input{src/bin-dec}
\section{Decimaal naar binair}
\input{src/dec-bin}
\section{Bits en bytes}
\input{src/bits-bytes}
\section{Duizenden of miljoenen}
\input{src/voorvoegsels}

\chapter{Binair rekenen}
\section{Optellen}
\input{src/binair_optellen}
\section{Aftrekken}
\input{src/binair_aftrekken}
\section{Vermenigvuldigen}
\input{src/binair_vermenigvuldigen}
