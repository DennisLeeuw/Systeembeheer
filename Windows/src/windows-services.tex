Services\index{services} is de Microsoft benaming voor processen\index{processen}. Processen draaien op de achtergrond en hebben geen grafische interface. Er is ook geen user interaction nodig om deze processen te laten draaien.
