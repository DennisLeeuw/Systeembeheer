...
\item[.NET]\index{.net} Een open source framework voor Windows, Linux en Mac OS X om voornamelijk web-based applicaties te ontwikkelen zoals Office365. Vooral bekent van de C\# programming language.
