Het Microsoft Management Console\index{microsoft management console}\index{management console} (MMC\index{mmc}) stamt uit 1997 en gebruikt zogenaamde snap-ins\index{snap-in}\index{mmc!snap-in}. Deze snap-ins worden gebruikt om bepaalde zaken op een Windows systeem te beheren of te controleren. Ook applicatie kunnen gebruik maken van de MMC API om configuratie items via MMC te laten beheren.
